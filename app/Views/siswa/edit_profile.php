        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group ">
                    ...
                    <input type="text" name="rt" class="form-control" data-mask value="<?= $siswa['rt'] ?>" value="<?= $siswa['rt'] ?>" required>

                </div>
                <div class="form-group ">
                    <label for="inputAddress2">RW</label>
                    <input type="text" name="rw" class="form-control " value="<?= $siswa['rw'] ?>" value=" <?= $siswa['rw'] ?>" required>
                </div>
                <div class="form-group ">
                    <label for="inputAddress2">Provinsi</label>

                    <select name="provinsi" class="form-control select2bs4 " style="width: 100%;" id="provinsi" value="<?= $siswa['provinsi'] ?>" required>
