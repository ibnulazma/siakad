...
<?php foreach ($nilai as $row) { ?>
    <div class="wrapper">
        <div class="header ">
            <table>
                <tr>
                    ...
                    <td>
                        <p class="center">YAYASAN SULUK INSAN KAMIL TARTILA <br>
                            <span class="smp">SMP INSAN KAMIL</span><br>
                            Jalan Raya Legok KM 06 N0 89 RT 07 RW 02 Legok-Tangerang
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <div class="container">
            <h5>HASIL PENGGALIAN POTENSI PSIKOMOTORIK MATA PELAJARAN</h5>
            <h5>(P3MP)</h5>
        </div>
        <table class="tabel2">
            <tr>
