...
<body>
    ...
    <div class="container text-sm" style="margin-top:50px;">
            ...
            <div class="col">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>Janis Kelamin</td>
                        <td>:</td>
                        <td colspan="6"><?= $siswa['jenis_kelamin'] ?></td>
                    </tr>
                    <tr>
                        <td>6.</td>
                        <td>Tempat dan Tanggal Lahir</td>
                        <td>:</td>
                        <td colspan="6"><?= $siswa['tempat_lahir'] ?>, <?= date('d M Y', strtotime($siswa['tanggal_lahir'])) ?></td>
                    </tr>
                    <tr>
                        <td>4.</td>
                        <td>Agama</td>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>c. Kecamatan</td>
                        <td>:</td>
                        <td colspan="3"><?= $siswa['nama_kecamatan'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                        <td>d. Kab/Kota</td>
                        <td>:</td>
                        <td colspan="3"><?= $siswa['city_name'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                        <td>e. Provinsi</td>
                        <td>:</td>
                        <td colspan="3"><?= $siswa['prov_name'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>13.</td>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Nama Ayah</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['nama_ayah'] ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>23.</td>
                            <td>Tahun Lahir</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['tahun_ayah'] ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>24.</td>
                            <td>Pendidikan</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['didik_ayah'] ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>25.</td>
                            <td>Pekerjaan</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['kerja_ayah'] ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>26.</td>
                            <td>Penghasilan</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['hasil_ayah'] ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>27.</td>
                            <td>No Telp</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['telp_ayah'] ?></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Nama Ibu</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['nama_ibu'] ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>29.</td>
                            <td>Tahun Lahir</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['tahun_ibu'] ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>30.</td>
                            <td>Pendidikan</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['didik_ibu'] ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>31.</td>
                            <td>Pekerjaan</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['kerja_ibu'] ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>32.</td>
                            <td>Penghasilan</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['hasil_ibu'] ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>33.</td>
                            <td>No Telp</td>
                            <td>:</td>
                            <td colspan="3"><?= $siswa['telp_ibu'] ?></td>
                        </tr>
                    </tbody>
                </table>
