...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/template2/main.css">
...
<body>
                ...
                <div class="ket-pribadi" style=" padding-top: 30px;">
                    ...
                    <table class="default-table ">
                        ...
                        <tr>
                            ...
                            <td>
                                <p>Anak Yatim/Piatu/Yatim Piatu</p>
                            </td>
                            <td>
                                <p>:</p>
                            </td>
                ...
                <div class="ket-pribadi ket-tempat-tinggal">
                    ...
                    <table class="table-nested">
                        ...
                        <table class="default-table tempat-tinggal">
                            ...
                            <tr>
                                <td>
                                    <p style="position: relative; top: -18px;">14.</p>
                                </td>
                                <td>
                                    <p style="position: relative; top: -18px;">Alamat Tersebut</p>
                                </td>
                                <td>
                                    <p style="position: relative; top: -18px;">:</p>
                                </td>
                                <td style="position: relative; top: 2px;">
                                    ...
                                    <p style="float: left; margin-left: 5px;">a. Tempat Tinggal Orang Tua</p>
                                    <div style="clear: both;"></div>
                                    <div class="box"></div>
                                    <p style="float: left; margin-left: 5px;">b. Menumpang pada orang lain</p>
                                    <div style="clear: both;"></div>
                                    <div class="box"></div>
                                    <p style="float: left; margin-left: 5px;">c. Di Asrama</p>
                                    <div style="clear: both;"></div>
                                </td>
                            ...
                            <tr style="position: relative; top: 5px;">
                                ...
                                <td>
                                    <p>Jarak dari Tempat Tinggal ke <br>Sekolah</p>
                                </td>
                                <td>
                                    <p>:</p>
                                </td>
                                <td>
                                    <div class="box" style="font-size: 0.8em;"></div>
                                    <p> Km</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <p style="position: relative; top: -15px;">16.</p>
                                </td>
                                <td>
                                    <p style="position: relative; top: -15px;">Kesekolah Dengan</p>
                                </td>
                                <td>
                                ...
                                <td style="position: relative; top: 0px;">
                                    <div class="box"></div>
                                    <p style="float: left; margin-left: 5px;">Kendaraan Umum</p>
                                    <div style="clear: both;"></div>
                                    <div class="box"></div>
                                    <p style="float: left; margin-left: 5px;">Kendaraan Pribadi</p>
                                    <div style="clear: both;"></div>
                                    <div class="box"></div>
                                    <p style="float: left; margin-left: 5px;">Jalan Kaki</p>
                                    <div style="clear: both;"></div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="default-table ket-kesehatan">
                            <tr>
                                ...
                                <td style="display: flex;align-items: flex-end;">
                                    <div class="box"><span style="font-size: 10px;"></span></div>
                            ...
                            <tr>
                                ...
                                <td style="position: relative; top: 5px; display: flex; align-items: center;">
                                    ...
                                    <div class="box"><b>√</b></div>
                                    <p style="float: left; margin-right: 5px; font-size: 10px">TBC</p>
                                    <div class="box"></div>
                                    <p style="float: left; margin-right: 5px; font-size: 10px">CACAR</p>
                                    <div class="box"></div>
                                    <p style="float: left; margin-right: 5px; font-size: 10px">LEVER</p>
                                    <div class="box"></div>
                                    <p style="float: left; margin-right: 5px; font-size: 10px">Malaria</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="margin-top: 5px; font-size: 10px;"></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td style="position: relative; top: 5px; display: flex;align-items: center;">
                                    <div class="box"><span style="font-size: 10px;"></span></div>
                                    <p style="float: left; margin-right: 5px; font-size: 10px">Cm</p>
                                    <div class="box"><span style="font-size: 10px;"></span></div>
                                    <p style="float: left; margin-right: 5px; font-size: 10px">Kg</p>
                                </td>
                            </tr>
                        </table>
                    ...
                    <table class="table-nested">
                        ...
                        <tr class="nested-data">
                            ...
                            <td style="position: relative; top: 5px; display: flex; align-items: center;">
                                ...
                                <div class="box"></div>
                                <p style="float: left; margin-right: 5px; font-size: 10px">SD</p>
                                <div class="box"></div>
                                <p style="float: left; margin-right: 5px; font-size: 10px">MI</p>
                                <div class="box"></div>
                                <p style="float: left; margin-right: 5px; font-size: 10px">SEDERAJAT</p>
            ...
            <div class="section-center">
                ...
                <div class="ket-pribadi ket-orangtua">
                    ...
                    <table style="height: 4cm;">
                        ...
                        <tr>
                            ...
                            <td>
                                <p>Alamat rumah dan nomor Telepon</p>
                            </td>
                            <td>
                                <p></p>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>Masih hidup/meninggal dunia</p>
                            </td>
                            <td>
                                <p></p>
                            </td>
                ...
                <div class="ket-pribadi " style="padding-top: 36px;">
                    ...
                    <div class="siswa">
                        ...
                        <table class="table-nested table-pindah nested-last" style="margin-top: 10px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>Tahun meninggalkan sekolah</p>
                                </td>
                                <td>
                                    <p>:</p>
                                </td>
                            ...
                            <tr class="nested-data nested-last">
                                ...
                                <td>
                                    <div class="box"></div>
                                    <p style="float: left; margin-left: 5px;">Melanjut ke .......</p>
                                    <div style="clear: both;"></div>
                                </td>
                            </tr>
                            ...
                            <tr class="nested-data nested-last">
                                ...
                                <td>
                                    <div class="box"></div>
                                    <p style="float: left; margin-left: 5px;">Bekerja di .........</p>
                                    <div style="clear: both;"></div>
                    </div>
                    </td>
                    </tr>
                    <tr class="nested-data nested-last">
                        ...
                        <td>
                            <div class="box"></div>
                            <p style="float: left; margin-left: 5px;">Dan lain-lain ......</p>
                            <div style="clear: both;"></div>
                </div>
                </td>
                </tr>
    ...
    <div class="section-right">
        <div class="foto foto-atas">
            ...
            <img src="http://sibuk.com/asset/img/foto_siswa/" class="foto" style="object-fit: cover;">
